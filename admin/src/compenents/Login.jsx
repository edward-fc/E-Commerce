        ...
        <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md '>
            ...
            <form onSubmit={onSubmitHandler}>
                ...
                <div className='mb-3 min-w-72'>
                    ...
                    <input onChange={(e)=>setPassword(e.target.value)} value={password} className='rounded-md w-full px-3 py-2 border border-gray-300 outline-none'type="password" placeholder='Enter yout password' required />
                </div>
